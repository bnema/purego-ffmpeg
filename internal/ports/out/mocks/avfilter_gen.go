...
// MockFilterCAPI is a test mock for FilterCAPI.
...
func (mock *MockFilterCAPI) GraphAlloc() unsafe.Pointer {
...
func (mock *MockFilterCAPI) GraphFree(graph unsafe.Pointer) {
...
func (mock *MockFilterCAPI) GraphCreateFilter(filtCtx unsafe.Pointer, filt unsafe.Pointer, name *byte, args *byte, opaque unsafe.Pointer, graphCtx unsafe.Pointer) int32 {
...
func (mock *MockFilterCAPI) GraphParsePtr(graph unsafe.Pointer, filters *byte, inputs unsafe.Pointer, outputs unsafe.Pointer, logCtx unsafe.Pointer) int32 {
...
func (mock *MockFilterCAPI) GraphConfig(graphctx unsafe.Pointer, logCtx unsafe.Pointer) int32 {
...
func (mock *MockFilterCAPI) GetByName(name *byte) unsafe.Pointer {
...
func (mock *MockFilterCAPI) BuffersrcAddFrameFlags(bufferSrc unsafe.Pointer, frame unsafe.Pointer, flags int32) int32 {
...
func (mock *MockFilterCAPI) BuffersinkGetFrame(ctx unsafe.Pointer, frame unsafe.Pointer) int32 {
